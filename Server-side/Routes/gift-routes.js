...
router.post("/", authMiddleware, adminMiddleware, requirePermission("products"), adminLogMiddleware, ctrl.createGift);
router.patch("/:giftId", authMiddleware, adminMiddleware, requirePermission("products"), adminLogMiddleware, ctrl.updateGift);
