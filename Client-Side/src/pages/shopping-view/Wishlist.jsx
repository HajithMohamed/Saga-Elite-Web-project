      ...
      <nav className="fixed top-0 w-full z-50 bg-white/80 dark:bg-slate-950/80 backdrop-blur-xl border-none shadow-sm shadow-slate-200/50">
        <div className="flex justify-between items-center w-full px-8 py-6 max-w-screen-2xl mx-auto">
          ...
          <div className="hidden md:flex items-center gap-10">
            <a className="font-manrope font-light tracking-tight text-slate-400 dark:text-slate-500 hover:text-slate-600 hover:opacity-70 transition-opacity duration-300" href="#">Collections</a>
            <a className="font-manrope font-light tracking-tight text-slate-400 dark:text-slate-500 hover:text-slate-600 hover:opacity-70 transition-opacity duration-300" href="#">Curated</a>
            <a className="font-manrope font-light tracking-tight text-slate-950 dark:text-white border-b border-slate-950 dark:border-white pb-1 hover:opacity-70 transition-opacity duration-300" href="#">Wishlist</a>
            <a className="font-manrope font-light tracking-tight text-slate-400 dark:text-slate-500 hover:text-slate-600 hover:opacity-70 transition-opacity duration-300" href="#">Orders</a>
          </div>
          <div className="flex items-center gap-6">
            ...
            <div className="flex items-center gap-4">
              <button className="text-slate-950 dark:text-white hover:opacity-70 transition-opacity duration-300 scale-95 active:scale-100">
