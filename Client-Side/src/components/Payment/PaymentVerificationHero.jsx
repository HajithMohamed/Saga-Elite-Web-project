...
const InfoPill = ({ icon: Icon, label, value }) => (
  <div className="flex items-center gap-3 rounded-2xl border border-white/10 bg-white/[0.03] px-4 py-3 backdrop-blur-sm">
    <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl border border-[#F2CA50]/20 bg-[#F2CA50]/10">
      <Icon className="h-4 w-4 text-[#F2CA50]" />
    </div>
    <div className="min-w-0">
      <p className="se-label text-[9px] tracking-[0.25em] text-[#99907c]">{label}</p>
      <p className="mt-0.5 truncate text-sm font-semibold text-[#e5e2e1]">{value || "—"}</p>
    </div>
  </div>
);
...
const PaymentVerificationHero = ({
  ...
  return (
    <section
      className="relative overflow-hidden rounded-[24px] border border-[#F2CA50]/10 bg-[#0E0E0E]"
    ...
    >
      ...
      {/* Gold top line */}
      <div className="absolute left-0 right-0 top-0 h-px bg-gradient-to-r from-transparent via-[#F2CA50]/40 to-transparent" />
      ...
      <div className="relative z-10 flex min-h-[160px] flex-col justify-center px-6 py-8 sm:min-h-[180px] sm:px-10 lg:min-h-[220px] lg:px-14 lg:py-10">
        ...
        <motion.div
          ...
          className="mb-4 inline-flex w-fit items-center gap-2 rounded-full border border-[#F2CA50]/20 bg-[#F2CA50]/5 px-3 py-1.5"
        >
          <ShieldCheck className="h-3.5 w-3.5 text-[#F2CA50]" />
          <span className="se-label text-[9px] tracking-[0.25em] text-[#F2CA50]">
        ...
        <motion.h1
          ...
          className="se-serif text-[28px] leading-tight text-[#e5e2e1] sm:text-[34px] lg:text-[40px]"
        >
        ...
        <motion.p
          ...
          className="se-body mt-2 max-w-xl text-sm leading-6 text-[#99907c] sm:text-base"
        >
