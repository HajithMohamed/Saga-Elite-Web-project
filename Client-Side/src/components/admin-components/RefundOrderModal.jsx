      ...
      {isOpen && order ? (
        ...
        >
          <motion.div
            ...
            className="w-full max-w-lg rounded-2xl border border-ink/[0.06] bg-panel shadow-[0_30px_60px_rgba(0,0,0,0.6)]"
          >
            <header className="flex items-start justify-between gap-4 border-b border-ink/[0.05] p-6">
              <div className="min-w-0">
                <p className="text-[10px] uppercase tracking-[0.2em] font-semibold text-gold-ink2">
                  Refund · Order Action
                </p>
                <h2 className="mt-2 text-lg font-semibold text-ink truncate">
              ...
              <button
                type="button"
                onClick={() => (submitting ? null : onClose?.())}
                className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full border border-ink/10 text-ink/60 hover:border-ink/20 hover:text-ink transition"
