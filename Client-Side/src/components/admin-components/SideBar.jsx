...
import { LayoutDashboard, ShoppingBag, ShoppingCart, Star, LogOut, User, Package, ImagePlus, MessageSquare, Users, Shield, Landmark } from 'lucide-react'
...
const SideBar = () => {
  ...
  const menuItems = [
    ...
    { label: 'Manual Payments', path: '/admin/manual-payments', icon: <Landmark className="h-5 w-5" /> },
